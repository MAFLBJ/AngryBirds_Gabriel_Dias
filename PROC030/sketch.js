...
class Estilingue {
    constructor(bodyA, pontoB, stiffness, length) {
        this.bodyA = bodyA;
        this.pontoB = pontoB;
        this.stiffness = stiffness;
        this.length = length;
    ...
    display() {
        if (this.estilingue.bodyA != null) {
            ...
            if (pointAstronauta.x <= 200) {
                push();
                strokeWeight(20);
                stroke(48, 22, 8);
                line(pointAstronauta.x - 10, pointAstronauta.y-5, this.pontoB.x - 25, this.pontoB.y - 3);
                line(pointAstronauta.x + 20, pointAstronauta.y-5, this.pontoB.x + 20, this.pontoB.y + 3);
