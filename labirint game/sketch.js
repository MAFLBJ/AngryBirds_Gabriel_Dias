...
function preload(){
 //careca de frente
  careca_frente_parado = loadImage('frente parado.png');
  careca_frente_andando1 = loadImage('frente andando 1.png');
  careca_frente_andando2 = loadImage('frente andando 2.png');
  //careca de lado
  careca_direita_parado = loadImage('lado direito parado.png');
  careca_direita_andando = loadImage('lado direito andando.png');
  careca_esquerda_parado = loadImage('lado esquerdo parado.png');
  careca_esquerda_andando = loadImage('lado esquerdo andando.png');
  //careca de trás
  careca_tras_parado = loadImage('trás parado.png');
  careca_tras_andando1 = loadImage('trás andando 1.png');
  careca_tras_andando2 = loadImage('trás andando 2.png');
  //vampiro
  vampiro_direita = loadImage('vampiro direita.png');
  vampiro_esquerda = loadImage('vampiro esquerda.png');
  //slenderman
  slendermanImg = loadImage('Slenderman.png');
  //fantasma
  fantasmaImg = loadImage('fantasma.png');
  //espinhos
  espinhos_baixo_img = loadImage('imagens do jogo/espinhos de baixo.png');
  espinhos_cima_img = loadImage('imagens do jogo/espinhos de cima.png');
